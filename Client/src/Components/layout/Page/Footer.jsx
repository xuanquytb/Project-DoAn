      ...
      <div id="footer">
        <div className="grid wide">
            ...
            <div className="row">
              <div className="col l-2-4 m-4 c-6 footer__items">
                ...
                <p className="hot-line">
                  Hotline:
                  <a href="tel: 1900-6035">1900-6035</a> <br />
              ...
              <div className="col l-2-4 m-4 c-4 footer__items none">
                <h4 className="footer__title">Hợp tác và liên kết</h4>
                <a href="" className="footer__links">
                ...
                <h4 className="footer__title sub-title">Chứng nhận bởi</h4>
                <div className="flex">
                  <a href="" className="footer__certification">
                    <img
          ...
          <div className="footer__address">
            <p className="footer__links-title">
              Địa chỉ văn phòng: 52 Út Tịch, phường 4, quận Tân Bình, thành phố
              Hồ Chí Minh
            </p>
            <p className="footer__links-title">
