                    ...
                    <Steps
                      current={
                        order.state === "Chờ xác nhận"
                          ? 0
                          : order.state === "Đã giao cho đơn vị vận chuyển"
                          ? 1
                          : order.state === "Đã giao hàng"
                          ? 2
                          : order.state === "Đơn hàng hoàn thành"
                          ? 4
                          : 0
                      }
                    >
                      <Step key="1" title="Chờ xác nhận" />
                      <Step key="2" title="Đã giao cho đơn vị vận chuyển" />
                      <Step key="3" title="Đã giao hàng" />
                      <Step key="4" title="Đơn hàng hoàn thành" />
                    </Steps>
                    <Button
                      type="primary"
                      shape="round"
                      onClick={(e) => handleShow(order)}
                      style={{ width: 190, height: 35, margin: 15 }}
                    >
                      Chi tiết đơn hàng
                    </Button>
                    {order.state === "Đã giao hàng" ? (
                      <Button
                        type="primary"
                        shape="round"
                        onClick={(e) => handConfirm(order)}
                        style={{ width: 190, height: 35, marginLeft: 790 }}
                      >
