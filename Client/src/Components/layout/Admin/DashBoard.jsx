          ...
          <Layout style={{ flexDirection: "column-reverse" }}>
            ...
            >
              ...
              <Route
                path="/user"
                render={(props) => (
                  <AuthDashboard {...props} authRoute="customer" />
                )}
              />
              <Route
                path="/employee"
                render={(props) => (
                  <AuthDashboard {...props} authRoute="employee" />
                )}
              />
              <Route
                path="/admin"
                render={(props) => (
                  <AuthDashboard {...props} authRoute="admin" />
                )}
              />
              <Route
                path="/product"
                render={(props) => (
                  <AuthDashboard {...props} authRoute="product" />
                )}
              />
              <Route
                path="/category"
                render={(props) => (
                  <AuthDashboard {...props} authRoute="category" />
                )}
              />
              <Route
                path="/brand"
