                ...
                <form action="" className="from-input">
                  <div className="input-Value input-name">
                    ...
                    <div className="input-name-right">
                      <span htmlFor="">Tên đăng nhập</span>
                      <input
                        type="text"
                        name="username"
                  ...
                  <div className="input-Value input-Password">
                    ...
                    <div className="input-Password-right">
                      <span htmlFor="">Nhập lại mật khẩu</span>
                      <input
                        type="text"
                        placeholder="*****************"
                        name="rePassword"
                  ...
                  <div className="btn-form">
                    <div className="more">
                      <span className="more-detail">Bạn đã có tài khoản?</span>
                      <a href="http://localhost:3000/login">Sign in</a>
                    </div>
                    <div className="btn-box">
                      <button className="btn-regiter" onClick={register}>
                        Đăng ký
                      </button>
                    </div>
                  </div>
