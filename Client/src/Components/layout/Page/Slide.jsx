      ...
      <div className="slider slider__noTop">
        <div className="slider__section2">
          <div className="slider__section2-item">
            <img src="../../../image/slider__body/image-2-1.png" alt="" />
          </div>
          <div className="slider__section2-item">
            <img
          ...
          <div className="slider__section2-item">
            <img src="../../../image/slider__body/image-2-3.png" alt="" />
          </div>
        </div>
      </div>
      <div className="slider slider__noTop">
      ...
      <div className="slider slider__noTop">
        <div className="slider__section4">
          <div className="slider__section4-item">
            <img src="../../../image/slider__body/image-3-1.png" alt="" />
          </div>
          <div className="slider__section4-item">
            <img src="../../../image/slider__body/image-3-2.png" alt="" />
          </div>
          <div className="slider__section4-item">
            <img src="../../../image/slider__body/image-3-3.png" alt="" />
          </div>
          <div className="slider__section4-item">
            <img src="../../../image/slider__body/image-3-4.png" alt="" />
          </div>
        </div>
      </div>
        ...
        <div className="slider__section8">
          <div className="slider__section8-head">
            <img
              ...
              alt=""
            />
            <h3 className="slider__section8-heading">Xu Hướng Mua Xắm</h3>
          </div>
