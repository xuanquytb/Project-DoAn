        ...
        <div className="slider slider__noTop">
          <div className="slider__section9">
            <div className="slider__section9-item">
              <img src="../../../image/slider__body/image-8-1.png" alt="" />
            </div>
            <div className="slider__section9-item">
              <img src="../../../image/slider__body/image-8-2.png" alt="" />
            </div>
            <div className="slider__section9-item">
              <img src="../../../image/slider__body/image-8-3.png" alt="" />
            </div>
          </div>
        </div>
          ...
          <div className="content__head" id="content__sticky">
            ...
            <div className="content__lists">
              <div className="content__list-item border__active">
                ...
                />
                <span className="list-item-info">Dành cho bạn</span>
              </div>
              <div className="content__list-item">
                <img
                  ...
                  className="list-item-img"
                />
                <span className="list-item-info">Flash coupon 50K</span>
              </div>
              <div className="content__list-item">
                <img
                  ...
                  className="list-item-img"
                />
                <span className="list-item-info">Giảm đến 40%</span>
              </div>
              <div className="content__list-item">
                <img
                  ...
                  className="list-item-img"
                />
                <span className="list-item-info">Deal siêu hot</span>
              </div>
              <div className="content__list-item">
                <img
                  ...
                  className="list-item-img"
                />
                <span className="list-item-info">Rẻ vô đối</span>
              </div>
              <div className="content__list-item">
                <img
                  ...
                  className="list-item-img"
                />
                <span className="list-item-info">Đi chợ siêu sale</span>
              </div>
              <div className="content__list-item">
                <img
              ...
              <div className="content__list-item">
                <img
                  ...
                  className="list-item-img"
                />
                <span className="list-item-info">Xu hướng thời trang</span>
              </div>
            </div>
          </div>
